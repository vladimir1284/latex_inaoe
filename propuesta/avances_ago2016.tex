...
%  the same classification quality than the original information system. 
  ...
  These algorithms will use some properties of the information system to conveniently select the traversing strategy for the search space. We will explore two variants of this problem, the problem of computing all reducts and the problem of computing globally shortest reducts. The problem of finding shortest reducts has also exponential complexity \citep{Lin04} but different pruning rules could be used.
  
  Our specific objectives are:
  \begin{enumerate}
  	\item Finding a relationship between some properties of the information system and the fastest 
...
\section{Results of the Current Period}
...
\section{Schedule}
  ...
  \begin{itemize}
  	...
  	\item Writing a paper on a new algorithm for computing all reducts in information systems (GCreduct).
  	\item Partially writing the PhD dissertation.
  \end{itemize}
  
  Notice that our schedule did not suffer variations from our previous evaluation.
 ...
 \begin{table}[h!]
 	...
 	\begin{tabular}{|p{7cm}|c|c|c|c|c|c|c|c|c|c|c|c|}
		...
		\cellcolor{blue}&\cellcolor[gray]{0.9}&\cellcolor[gray]{0.9}&\cellcolor[gray]{0.9}&
		...
		\cellcolor[gray]{0.9}&&\cellcolor[gray]{0.9}&\cellcolor[gray]{0.9}&&&&\\
		\hline
		Experiments run &&&\cellcolor{blue}&\cellcolor{blue}&&\cellcolor[gray]{0.9}&\cellcolor[gray]{0.9}&&
		\cellcolor[gray]{0.9}&&&\\
		\hline
		Writing papers &\cellcolor{blue}&&\cellcolor{blue}&&\cellcolor[gray]{0.9}&&\cellcolor[gray]{0.9}&&
		\cellcolor[gray]{0.9}&&&\\
		\hline
		Writing the PhD dissertation &&&&\cellcolor{blue}&\cellcolor[gray]{0.9}&\cellcolor[gray]{0.9}&
		\cellcolor[gray]{0.9}&\cellcolor[gray]{0.9}&\cellcolor[gray]{0.9}&&&\\
		\hline
