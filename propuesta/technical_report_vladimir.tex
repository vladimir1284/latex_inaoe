...
\subsection{Algorithms for Reducts and Testors Computation}
  ...
  The first work developed in the reduction of the search space for typical testors~\citep{Ruiz85}, follows 
  ...
  evaluations. Subsequent algorithm~\citep{Santiesteban03},~\citep{Sanchez07} and~\citep{Lias09} propose
  more sophisticated evaluation orders. Recently, a new internal typical testor--finding algorithm was
  proposed~\citep{Alba14}. In our experience, non of this algorithm is the fastest for all dataset.
