...
\begin{letter}{}
  ...
  \begin{enumerate}
	...
	\begin{itemize}		
		...
		\textcolor{blue}{Thus, there is no polynomial complexity algorithm for computing all the reducts of a decision system.}% However, the performance of the algorithms for computing all reducts is strongly related to the characteristics of the \textit{SBDM}. 
