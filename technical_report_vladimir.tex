...
\subsection{Third Experiment}\label{exprimet3}
 ...
 \subsection{Fourth Experiment}
  This experiment is similar to experiment~\ref{exprimet3} but we will be evaluating our algorithm over 
  randomly selected large benchmarking datasets from \cite{Bache13}. All the experiment elements are the
  same as in experiment~\ref{exprimet3} except for those stated bellow.
  \paragraph{Experiment Design} 
	  \begin{description}
